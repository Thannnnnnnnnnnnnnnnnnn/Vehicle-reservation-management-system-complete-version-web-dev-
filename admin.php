...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($connections->query($sql_table) === TRUE) {
...
<div class="nav_list"> 
    ...
    <br><br>
        ...
        <div class="col">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="add-button" data-bs-toggle="modal" data-bs-target="#addVehicleModal">
                        Add Vehicle 
                    </button>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="Plate_no" name="Plate_no" required placeholder="Enter vehicle plate number">
        </div>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="approved.php?id=<?php echo $row['Reservation_id']; ?>" method="POST" style="display: inline;">
                                    <button type="submit" class="approve-button" style="border: none; padding: 0;">
                                        <i class="fas fa-check"></i>
                                    </button>
                                   <b> |</b>
                                </form>
                                <form action="rejected.php?id=<?php echo $row['Reservation_id']; ?>" method="POST" style="display: inline;">
                                    <button type="submit" class="reject-button" style="border: none;  padding: 0;">
                                        <i class="fas fa-times"></i>
                                    </button>
                                    <b> |</b>
                                </form>
                                <form action="delete.php?id=<?php echo $row['Reservation_id']; ?>" method="POST" style="display: inline;">
